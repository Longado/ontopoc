...
const copy = {
  zh: {
    ...
    limits: [
      ...
      "除了合成的示例公司，还在三份公开的真实数据上试过（芝加哥市政府合同、一家上市公司的关联交易管理制度、英国零售交易），每份都逼出过问题并已修掉；还没有真实客户用过。",
  ...
  en: {
    ...
    limits: [
      ...
      "Beyond the synthetic demo company, tried on three real public files (Chicago city contracts, a listed company's related-party transaction policy, UK retail transactions), each of which exposed problems that are now fixed; no real client has used it yet.",
