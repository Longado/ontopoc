...
const copy = {
  zh: {
    ...
    problems: [
      ...
      ["每次跑出来不一样", "同一份文件重跑，模型搭的本体会有出入。示例公司的两次运行，就差了一个对象和一条关系。"],
    ],
    methodKicker: "做法",
  ...
  en: {
    ...
    problems: [
      ...
      ["Every run differs", "Rerun on the same file and the model's ontology changes. The demo company's two runs differ by one object and one relation."],
    ],
    methodKicker: "METHOD",
