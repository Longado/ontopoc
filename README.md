...
Every feature on the page is also a standard MCP tool (stdio, 22 tools) for Claude Code or any MCP client: `claude mcp add ontopoc -- env PYTHONPATH=$PWD/src python3 -m ontology_poc_generator.mcp_server`. See `docs/MCP.md`.
